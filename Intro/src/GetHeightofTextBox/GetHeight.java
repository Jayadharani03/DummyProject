...
public class GetHeight {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement f=driver.findElement(By.cssSelector("input[name='name']"));
		f.sendKeys(s);
	
		System.out.println(f.getRect().getDimension().getHeight());
		System.out.println(f.getRect().getDimension().getWidth());
